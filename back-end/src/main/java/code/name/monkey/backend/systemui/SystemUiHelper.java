...
package code.name.monkey.backend.systemui;
...
public final class SystemUiHelper {
     ...
     * {@link code.name.monkey.backend.systemui.SystemUiHelper} was instantiated with.
     */
    ...
    /**
     * Show the system UI. What this means depends on the mode this {@link code.name.monkey.backend.systemui.SystemUiHelper} was
     * instantiated with.
     * <p>
    ...
    /**
     * Hide the system UI. What this means depends on the mode this {@link code.name.monkey.backend.systemui.SystemUiHelper} was
     * instantiated with.
     * <p>
     * <p>Any currently queued delayed hide requests will be removed.
     */
