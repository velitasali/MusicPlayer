...
public class AlbumLoader {
    ...
    @NonNull
    public static Observable<ArrayList<Album>> getAlbums(@NonNull final Context context, String query) {
        Observable<ArrayList<Song>> songs = SongLoader.getSongs(SongLoader.makeSongCursor(
                context,
    ...
    @NonNull
    public static Observable<ArrayList<Album>> splitIntoAlbums(@Nullable final Observable<ArrayList<Song>> songs) {
        return Observable.create(e -> {
