...
public class HolidayPlaybackControlsFragment extends AbsPlayerControlsFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View layout = inflater.inflate(R.layout.fragment_holiday_controls_fragment, container, false);
    ...
    private void setUpPlayPauseFab() {
        ...
        TintHelper.setTintAuto(playPauseFab, ContextCompat.getColor(getContext(), R.color.md_red_A200), true);
    }
    ...
    protected void setUpProgressSlider() {
        ...
        setProgressBarColor(progressSlider, ContextCompat.getColor(getContext(), R.color.md_red_A200));
    }
