...
import com.retro.musicplayer.backend.loaders.SortedCursor;
...
public final class FileUtil {
    ...
    @NonNull
    public static Observable<ArrayList<Song>> matchFilesWithMediaStore(@NonNull Context context, @Nullable List<File> files) {
